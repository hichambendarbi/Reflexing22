          ...
          <div className="col-md-8 text-center heading-section ">
            ...
            <div className="col-md-12 nav-link-wrap">
	            <div className="nav nav-pills d-flex text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						  	...
						  	<NavLink className="nav-link"  aria-selected="false" href="/Partenariat"><h5>Partenariat</h5></NavLink>
                ...
                <NavLink className="nav-link  active" id="v-pills-1-tab" data-toggle="pill" role="tab" aria-controls="v-pills-1" aria-selected="true" href="/Chat"><h5>Chat</h5></NavLink>
	              ...
	              <div className="tab-pane py-2 fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
	              	<div className="row departments">
	              		...
	              		<div className="col-lg-8">
	              			<h2>Chater avec des professionelles</h2>
