    ...
    <div>        
    	...
    	<div className="container">
          ...
          <div className="col-md-8 text-center heading-section ">
          	<span className="subheading">Espace patients</span>
            <h2 className="mb-4">Preparez vos examen</h2>
            <p>Nos patients ayant une hypere confiance a nos examen hna khassna ngolo lpatient 3lach howa dakhel lhad la page w details ltaht... c est une paragrave moutivante</p>
          </div>
        </div>
